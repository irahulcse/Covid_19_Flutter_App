...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'India Corona Virus Updates'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  int totalcases = 0, recovered = 0, deaths = 0;
                            ...
                            layers: [
                              new flutterMap.TileLayerOptions(
                                urlTemplate: "https://api.tiles.mapbox.com/v4/"
                                    "{id}/{z}/{x}/{y}@2x.png?access_token=pk.eyJ1IjoiZnJpc2swMSIsImEiOiJjazh6bTRia28xaXVjM29zNzBpbWxteDEzIn0.zKPMVv95tkc6hJ4jAN1Hzg",
                                additionalOptions: {
                                  'accessToken':
                                      'pk.eyJ1IjoiZnJpc2swMSIsImEiOiJjazh6bTRia28xaXVjM29zNzBpbWxteDEzIn0.zKPMVv95tkc6hJ4jAN1Hzg',
                                  'id': 'mapbox.streets',
                                },
                              ),
